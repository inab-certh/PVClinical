...
urlpatterns = [
    ...
    path('char/<int:sc_id>/<int:ir_id>', views.characterizations, name='edit_char'),
    path('char/<int:sc_id>/<int:ir_id>/<int:read_only>', views.characterizations, name='edit_char'),
