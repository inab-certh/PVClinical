...
from app.entrezpy import requester
from app.entrezpy.base import monitor
...
class EutilsQuery:
  ...
  """References :class:`requester.Requester` """

  query_monitor = monitor.QueryMonitor()
  """References :class:`monitor.QueryMonitor` """
