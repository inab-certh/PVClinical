...
from app.entrezpy.elink import elink_result
from app.entrezpy.elink.linkset import bare
from app.entrezpy.elink.linkset import linked
from app.entrezpy.elink.linkset import relaxed
...
class ElinkAnalyzer(analyzer.EutilsAnalyzer):
  ...
  def __init__(self):
    """:ivar result: :class:`elink_result.ElinkResult`"""
    super().__init__()

  def init_result(self, response, request):
    """Inits :class:`elink_result.ElinkResult`"""
    if not self.result:
      self.result = elink_result.ElinkResult(request.query_id,
                                                            request.cmd)

  def analyze_error(self, response, request):
    """Implements virtual function :func:`analyzer.analyze_error`.
    """
  ...
  def analyze_result(self, response, request):
    """Implements virtual method :meth:`analyzer.analyze_result`.
