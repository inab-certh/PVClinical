...
from app.entrezpy.epost import epost_result
...
class EpostAnalyzer(analyzer.EutilsAnalyzer):
  ...
  def init_result(self, response, request):
    """Implements :meth:`analyzer.EutilsAnalyzer.init_result` and
       inits :class:`entrezpy.epost.epost_result.EpostResult`.
    """
    if not self.result:
      self.result =epost_result.EpostResult(response, request)

  def analyze_result(self, response, request):
    """Implements :meth:`analyzer.EutilsAnalyzer.analyze_result`.
